...
🤖 **Современный интеллектуальный чат-интерфейс с поддержкой множественных AI провайдеров**

Мощная платформа для взаимодействия с различными AI моделями.<br/>
Поддерживает синтез речи, мультимодальность и расширенную систему плагинов.<br/>
Развертывание за один клик вашего приватного AI чат-приложения.

**Русский** · [English](./README.en.md) · [Документация](#) · [Обратная связь](https://github.com/your-username/api-chat/issues)

</div>

## 🌟 Особенности

- 🤖 **Множественные AI провайдеры** - Поддержка OpenAI, Anthropic, Google Gemini и других
- 💬 **Интуитивный интерфейс** - Современный и удобный пользовательский интерфейс  
- 🎨 **Настраиваемые темы** - Светлая и темная тема
...
```bash
git clone https://github.com/your-username/api-chat.git
cd api-chat
```
...
4. Настройте API ключи в `.env.local`:
```env
