...
export const UTM_SOURCE = 'api_chat_preview';

export const OFFICIAL_URL = 'https://your-domain.com';
export const OFFICIAL_PREVIEW_URL = 'https://chat-preview.your-domain.com';
export const OFFICIAL_SITE = 'https://your-domain.com';

export const OG_URL = '/og/cover.png?v=1';

export const GITHUB = 'https://github.com/your-username/api-chat';
export const GITHUB_ISSUES = urlJoin(GITHUB, 'issues/new/choose');
export const CHANGELOG = 'https://your-domain.com/changelog';
export const DOCKER_IMAGE = 'https://hub.docker.com/r/your-username/api-chat';
...
export const FEEDBACK = 'https://github.com/your-username/api-chat/issues/new/choose';
export const PRIVACY_URL = urlJoin(OFFICIAL_SITE, '/privacy');
export const TERMS_URL = urlJoin(OFFICIAL_SITE, '/terms');

export const PLUGINS_INDEX_URL = 'https://plugins.your-domain.com';

export const MORE_MODEL_PROVIDER_REQUEST_URL =
  'https://github.com/your-username/api-chat/discussions/new';

export const MORE_FILE_PREVIEW_REQUEST_URL =
  'https://github.com/your-username/api-chat/discussions/new';

export const AGENTS_INDEX_GITHUB = 'https://github.com/your-username/api-chat-agents';
