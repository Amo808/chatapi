...
const AppTheme = memo<AppThemeProps>(
  ({
    ...
    useEffect(() => {
      setCookie(APP_THEME_PRIMARY_COLOR, primaryColor);
    }, [primaryColor]);

    useEffect(() => {
      setCookie(APP_THEME_NEUTRAL_COLOR, neutralColor);
    }, [neutralColor]);
    ...
    return (
      <ThemeProvider
        ...
        onAppearanceChange={(appearance) => {
          ...
          setCookie(APP_THEME_APPEARANCE, appearance);
        }}
        theme={{
          cssVar: true,
          token: {
